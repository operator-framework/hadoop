...
RUN curl -L -o cmake-$CMAKE_VERSION-Linux-x86_64.sh https://github.com/Kitware/CMake/releases/download/v$CMAKE_VERSION/cmake-$CMAKE_VERSION-Linux-x86_64.sh
...
RUN curl -L -o apache-maven-$MAVEN_VERSION-bin.tar.gz http://www.eu.apache.org/dist/maven/maven-3/$MAVEN_VERSION/binaries/apache-maven-$MAVEN_VERSION-bin.tar.gz
...
RUN alternatives --install /usr/bin/mvn mvn /usr/local/maven/apache-maven-$MAVEN_VERSION/bin/mvn 1
